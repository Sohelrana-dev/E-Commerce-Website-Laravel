    ...
    <div class="container container-fluid-sm">
        <div class="hero-slider">
            ...
            <div class="hero-slider-item">
                <div class="slider-bg">
                    <img src="{{ asset('uploads/frontend/banner') }}/{{ $banner->banner_image }}" alt="">
                </div>
    ...
    <div class="container">
        ...
        <div class="featured-categorie-slider owl-carousel">
            ...
            <div class="featured-item">
                <div class="images">
                    <img style="width: 80px;" class="m-auto" src="{{ asset('uploads/category') }}/{{ $category->icon }}" alt="">
                </div>
                <div class="text">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-12">
                ...
                <div class="offer-wrap" style="background: url({{ asset('uploads/offer/left') }}/{{ $offer->image }});">
                    <div class="content">
                        <h2>{{ $offer->title }}</h2>
                        <span class="offer-price">&#2547;{{ $offer->discount_price }}</span>
                        <del>&#2547;{{ $offer->price }}</del>
            ...
            <div class="col-lg-6 col-md-12">
                @foreach ($offer2 as $offer)
                <div class="banner-two-wrap" style="background: url({{ asset('uploads/offer/right') }}/{{ $offer->image }});">
                    <div class="text">
                        <h2>{{ $offer->title }}</h2>
                        <h4>{{ $offer->sub_title }}</h4>
                        <a class="theme-btn-s2" href="product.html">Shop Now</a>
                    </div>
                </div>
                @endforeach
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="product-item">
                        <div class="image">
                            <img style="height:260px;" src="{{ asset('uploads/product/preview') }}/{{ $product->preview }}" alt="">
                            @if ($product->discount)
                        ...
                        <div class="text">
                            <h2>
                                ...
                                <a href="{{ route('product.details', $product->slug) }}">{{ substr($product->product_name, 0, 20).'..' }}</a>
                                @else
    ...
    <div class="container">
        ...
        <div class="upcoming-offer">
            ...
            <div class="right-image">
                <img width="350" src="{{ asset('uploads/newyear_offer') }}/{{ $newyear->image }}" alt="">
            </div>
        ...
        <div class="row g-0">
            <div class="col-lg-6 col-12">
                <ul class="special-product">
                    <li>
                        @foreach ($dealday1 as $dealday)
                        <div class="product-item">
                            <div class="image">
                                <img style="width: 300px; height:240px;" src="{{ asset('uploads/dealday/left') }}/{{ $dealday->image }}"
                                    alt="">
                            </div>
                            <div class="text">
                                <h2><a href="product-single.html">{{ $dealday->title }}</a></h2>
                                <div class="rating-product">
                                    <i class="fi flaticon-star"></i>
                                    <i class="fi flaticon-star"></i>
                                    <i class="fi flaticon-star"></i>
                                ...
                                <div class="price">
                                    <span class="present-price">&#2547;{{ $dealday->discount_price }}</span>
                                    <del class="old-price">&#2547;{{ $dealday->price }}</del>
                                </div>
                                <div class="shop-btn">
                                    <a class="theme-btn-s2" href="product.html">Shop Now</a>
                                </div>
            ...
            <div class="col-lg-6 col-12">
                <ul class="special-product">
                    <li>
                        @foreach ($dealday2 as $dealday)
                        <div class="product-item">
                            <div class="image">
                                <img style="width: 300px; height:240px;" src="{{ asset('uploads/dealday/right') }}/{{ $dealday->image }}"
                                    alt="">
                            </div>
                            <div class="text">
                                <h2><a href="product-single.html">{{ $dealday->title }}</a></h2>
...
<section class="themart-trendingproduct-section section-padding">
    <div class="container">
        ...
        <div class="trendin-slider owl-carousel">
            ...
            <div class="product-item">
                <div class="image">
                    <img style="height: 250px; width:250px;" class="m-auto" src="{{ asset('uploads/product/preview') }}/{{ $product->preview }}" alt="">
                    @if ($product->discount)
                        <div class="tag sale">-{{ $product->discount }}%</div>
                    @else
                        <div class="tag new">New</div>
                ...
                <div class="text">
                    <h2>
                        @if (strlen($product->product_name) > 20)
                           <a href="product-single.html">{{ substr($product->product_name, 0, 20).'..' }}</a>
                        @else
                           <a href="product-single.html">{{ $product->product_name }}</a>
                        @endif
                    </h2>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="highlight-wrap">
                    ...
                    <div class="product-card">
                        <div class="card-image">
                            <div class="image">
                                <img style="width:150px; height:120px;" src="{{ asset('uploads/product/preview') }}/{{ $product->preview }}" alt="">
                            </div>
                        </div>
                        <div class="content">
                            <h3>
                                @if (strlen($product->product_name) > 15)
                                <a href="product-single.html">{{ substr($product->product_name, 0, 15).'..' }}</a>
                                @else
                                <a href="product-single.html">{{ $product->product_name }}</a>
                                @endif
                            </h3>
