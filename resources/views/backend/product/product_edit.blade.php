                            ...
                            <div class="mb-3">
                                ...
                                <select name="subcategory_id" class="form-select subcategory">
                                    ...
                                    @foreach($subcategories as $subcategory)
                                        <option {{ $products->subcategory_id == $subcategory->id?'selected':'' }} value="{{ $subcategory->id }}">{{ $subcategory->subcategory_name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-lg-5">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="discount"
                                    placeholder="enter product discount" value="{{ $products->discount }}">
                            </div>
                        </div>
                        <div class="col-lg-10">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control border-0 px-0" name="tag" id="input-tags"
                                    placeholder="enter product tag" value="{{ $products->tag }}">
                            </div>
                        </div>
                        <div class="col-lg-10">
                            <div class="mb-3">
                                <label for="" class="form-label">Short Description</label>
                                <textarea class="form-control" id="summernote3" name="short_desp" cols="80" rows="10">{!! $products->short_desp !!}</textarea>
                            </div>
                        </div>
                        <div class="col-lg-10">
                            <div class="mb-3">
                                ...
                                <textarea name="long_desp" id="summernote" cols="50" rows="10"
                                     class="form-control">{!! $products->long_desp !!}</textarea>
                            </div>
                        </div>
                        <div class="col-lg-10">
                            <div class="mb-3">
                                ...
                                <textarea name="add_info" id="summernote2" cols="800" rows="10"
                                    placeholder="enter additional information" class="form-control">{!! $products->add_info !!}</textarea>
                            </div>
                        </div>
                        <div class="col-lg-5">
                            <div class="mb-3">
                                ...
                                @error('preview')
                                    <strong class="text-danger">{{ $message }}</strong>
                                @enderror
                                <img class="mt-3" src="{{ asset('uploads/product/preview') }}/{{ $products->preview }}" id="blah" alt="" width="150">
                            </div>
                        </div>
                        <div class="col-lg-10">
                            <div class="mb-3 d-flex justify-content-end">
                                <button class="btn btn-success" type="submit">Product Update</button>
                            </div>
                        </div>
                    </div>
                </form>
...
@endif
@if(session('product_up_success'))
    <script>
        Swal.fire({
            position: "top-end",
            icon: "success",
            title: "{{ session('product_up_success') }}",
            showConfirmButton: false,
            timer: 1500
        });
